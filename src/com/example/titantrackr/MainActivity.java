...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mNfcTextView = (TextView) findViewById(R.id.nfcTextView);
		mNfcAdapter = NfcAdapter.getDefaultAdapter(this);
		
		//Check to see NFC enabled 
		if (mNfcAdapter == null) {
			// Stop here if NFC is not supported.
			Toast.makeText(this, "This device doesn't support NFC.", Toast.LENGTH_SHORT).show();
			/*finish();
			return; */
		}
		if (!mNfcAdapter.isEnabled()) {
			//If it is supported but not enabled.
			mNfcTextView.setText("NFC is disabled.");
		} else {
			//Otherwise set the text to 'Attach NFC Tag to read the content.'
			mNfcTextView.setText(R.string.nfcText);
		}
	...
	private void sendToManual(){
		Intent i = new Intent(MainActivity.this, EnterManually.class);
		//Get username from Login page
		String userName = (getIntent().getExtras().getString("username"));
		i.putExtra("userName", userName);
		startActivity(i);
	...
	protected void onResume() {
		...
		//Activity must be in the foreground
	...
	protected void onNewIntent(Intent intent) {
		 ...
		 * 
		 * In this case method gets called, when the user attaches a Tag to the device.
		 */
		handleIntent(intent);
	}
	...
	public static void setupForegroundDispatch(final Activity activity, NfcAdapter adapter) {
		...
		// Set filter as in manifest (NDEF_DISCOVERED)
	...
	private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
		...
		protected void onPostExecute(String result) {
			if (result != null) {
				...
				Intent intent = new Intent(MainActivity.this, NfcOverview.class);
